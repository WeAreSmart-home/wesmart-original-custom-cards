...
Some cards have graduated from Labs into their own standalone repositories:

| Project | Card repo | HA integration repo |
|---------|-----------|---------------------|
| WeSmart Garbage | [wesmart-garbage-card](https://github.com/WeAreSmart-home/wesmart-garbage-card) | [wesmart-garbage](https://github.com/WeAreSmart-home/wesmart-garbage) |
